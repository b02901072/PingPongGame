	...
	if gamestate == "playmode":
		...
		if pm == 2:
			...
			if accelball == 0:
				ball_speedx,ball_speedy = 400,400
			if accelball == 1:
				pygame.draw.circle(screen, (255,153,0), (int(ballx),int(bally)), 10,0)
			if accelball == 0:
	...
	if gamestate == "loading" :
		...
		if loadpercentage <= 150:	
			...
			if loadpercentage <= 150 and loadpercentage >= 100:
				...
				screen.blit(pygame.font.SysFont('Times New Roman', 45).render("100", True, (0,0,0)), (480 -15, 465))
...
#=================================================================================================#
	if gamestate == 0:    #準備階段#
		screen.blit(background,(0,0))
		if mode == 3:
			if survivalscore > sur_1p_top5[5]:
				if survivalscore > sur_1p_top5[1]:
					sur_1p_top5.insert(1,survivalscore)
					breakrecord = 1
				if survivalscore < sur_1p_top5[1] and survivalscore > sur_1p_top5[2]:
					sur_1p_top5.insert(2,survivalscore)
				if survivalscore < sur_1p_top5[2] and survivalscore > sur_1p_top5[3]:
					sur_1p_top5.insert(3,survivalscore)
				if survivalscore < sur_1p_top5[3] and survivalscore > sur_1p_top5[4]:
					sur_1p_top5.insert(4,survivalscore)
				if survivalscore < sur_1p_top5[4] and survivalscore > sur_1p_top5[5]:
				...
				f.close()	
		if mode == 4:
			if survivalscore > sur_2p_top5[5]:
				if survivalscore > sur_2p_top5[1]:
					sur_2p_top5.insert(1,survivalscore)
					breakrecord = 1
				if survivalscore < sur_2p_top5[1] and survivalscore > sur_2p_top5[2]:
					sur_2p_top5.insert(2,survivalscore)
				if survivalscore < sur_2p_top5[2] and survivalscore > sur_2p_top5[3]:
					sur_2p_top5.insert(3,survivalscore)
				if survivalscore < sur_2p_top5[3] and survivalscore > sur_2p_top5[4]:
					sur_2p_top5.insert(4,survivalscore)
				if survivalscore < sur_2p_top5[4] and survivalscore > sur_2p_top5[5]:
				...
				f.close()
		if mode == 5:
			if catchscore > catch_1p_top5[5]:
				if catchscore > catch_1p_top5[1]:
					catch_1p_top5.insert(1,catchscore)
					breakrecord = 1
				if catchscore < catch_1p_top5[1] and catchscore > catch_1p_top5[2]:
					catch_1p_top5.insert(2,catchscore)
				if catchscore < catch_1p_top5[2] and catchscore > catch_1p_top5[3]:
					catch_1p_top5.insert(3,catchscore)
				if catchscore < catch_1p_top5[3] and catchscore > catch_1p_top5[4]:
					catch_1p_top5.insert(4,catchscore)
				if catchscore < catch_1p_top5[4] and catchscore > catch_1p_top5[5]:
				...
				f.close()	
		if mode == 6:
			if catchscore > catch_2p_top5[5]:
				if catchscore > catch_2p_top5[1]:
					catch_2p_top5.insert(1,catchscore)
					breakrecord = 1
				if catchscore < catch_2p_top5[1] and catchscore > catch_2p_top5[2]:
					catch_2p_top5.insert(2,catchscore)
				if catchscore < catch_2p_top5[2] and catchscore > catch_2p_top5[3]:
					catch_2p_top5.insert(3,catchscore)
				if catchscore < catch_2p_top5[3] and catchscore > catch_2p_top5[4]:
					catch_2p_top5.insert(4,catchscore)
				if catchscore < catch_2p_top5[4] and catchscore > catch_2p_top5[5]:
		...
		if newhigh == 1:
			...
			if breakrecord == 0:
				screen.blit(pygame.font.SysFont('Times New Roman', 50).render("New high score !", True, (255, 255, 255)), (300, 200))
			if breakrecord == 1:	
			...
			if events.type == pygame.KEYDOWN:	
				if events.key == pygame.K_ESCAPE:
					...
					if ran2 >= 0 and ran2 < 1:
						...
						ball2_dirx,ball2_diry=1.22,-0.71
					if ran3 >= 0 and ran3 < 1:
						ball3_dirx,ball3_diry=1.22,0.71
					elif ran3 >= 1 and ran3 < 2:
						ball3_dirx,ball3_diry=1,1						
					elif ran3 >= 2 and ran3 < 3:
						ball3_dirx,ball3_diry=1.13,0.85
					elif ran3 >= 3 and ran3 < 4:
						ball3_dirx,ball3_diry=-1.13,0.85
					elif ran3 >= 4 and ran3 < 5:
						ball3_dirx,ball3_diry=-1,1
					elif ran3 >= 5 and ran3 < 6:
						ball3_dirx,ball3_diry=-1.22,0.71
					elif ran3 >= 6 and ran3 < 7:
						ball3_dirx,ball3_diry=-1.22,-0.71
					elif ran3 >= 7 and ran3 < 8:
						ball3_dirx,ball3_diry=-1,-1
					elif ran3 >= 8 and ran3 < 9:
						ball3_dirx,ball3_diry=-1.13,-0.85
					elif ran3 >= 9 and ran3 < 10:
						ball3_dirx,ball3_diry=1.13,-0.85
					elif ran3 >= 10 and ran3 < 11:
						ball3_dirx,ball3_diry=1,-1
					elif ran3 >= 11 and ran3 <= 12:
						ball3_dirx,ball3_diry=1.22,-0.71
			...
			if (invisibility%2 == 0) or ( invisibility%2 == 1 and  ((ball3x < 0.6*mid_width or ball3x > 1.4*mid_width) or (ball3x > 0.99*mid_width and ball3x < 1.01*mid_width) )) or (accelball3 == 1):
				if mode == 5 or mode == 6:
					if accelball3 == 1 and ball3 == 1:
						pygame.draw.circle(screen, (255,153,0), (int(ball3x),int(ball3y)), ball3_r,0)			
...
#=================================================================================================#
	if gamestate == 2: #CatchBall#
		...
		if ball == 0:
			...
			ball_speedx,ball_speedy = 350,350
			ballx,bally = 900,320
			if (gameseconds - balldeadtime) >= 5000:
				ball = 1
		...
		if ball2 == 0:
			...
			ball2_speedx,ball2_speedy = 349,349
			ball2x,ball2y = 900,320
			if (gameseconds - ball2deadtime) >= 5000 and gameseconds > 15000:
				ball2 = 1
		...
		if ball3 == 0:
			...
			ball3_speedx,ball3_speedy = 348,348
			ball3x,ball3y = 900,320
			if (gameseconds - ball3deadtime) >= 5000 and gameseconds > 30000:
				ball3 = 1
		ballcountdown = 5-int((gameseconds - balldeadtime)/1000)
		ball2countdown = 5-int((gameseconds - ball2deadtime)/1000)
		ball3countdown = 5-int((gameseconds - ball3deadtime)/1000)
		#-----------------------------球撞到左邊的邊緣時END-----------------------------#
		if ran_reflect%2 == 1:
			screen.blit(bounce_50,(410,5))
		if ran_reflect%2 == 0:
		...
		if ball == 1:
			pygame.draw.circle(screen, (204,255,255), (50,30),20,0)
			screen.blit(pygame.font.SysFont('Times New Roman', 30).render("%d"%(catchballscore), True, (0, 0, 102)), (41, 13))
		if ball == 0:
			screen.blit(pygame.font.SysFont('Times New Roman', 40).render("%d"%(ballcountdown), True, (204, 255, 255)), (38, 8))
		if ball2 == 1:
			pygame.draw.circle(screen, (255,153,153), (110,30), 20,0)	
			screen.blit(pygame.font.SysFont('Times New Roman', 30).render("%d"%(catchball2score), True, (102, 0, 0)), (101, 13))
		if ball2 == 0 and gameseconds > 15000:
			screen.blit(pygame.font.SysFont('Times New Roman', 40).render("%d"%(ball2countdown), True, (255,153,153)), (98, 8))
		if ball3 == 1:
			pygame.draw.circle(screen, (102,255,102), (170,30), 20,0)	
			screen.blit(pygame.font.SysFont('Times New Roman', 30).render("%d"%(catchball3score), True, (0, 102, 0)), (161, 13))
		if ball3 == 0 and gameseconds > 30000:
			screen.blit(pygame.font.SysFont('Times New Roman', 40).render("%d"%(ball3countdown), True, (102,255,102)), (158, 8))
		if pointchange > 0:
...
#=================================================================================================#	
	if gamestate == "highscore":
		...
		screen.blit(pygame.font.SysFont('Times New Roman', 40).render("1st", True, (255,255,255)), (60,240))
		screen.blit(pygame.font.SysFont('Times New Roman', 40).render("2nd", True, (255,255,255)), (60,310))
		screen.blit(pygame.font.SysFont('Times New Roman', 40).render("3rd", True, (255,255,255)), (60,380))
		screen.blit(pygame.font.SysFont('Times New Roman', 40).render("4th", True, (255,255,255)), (60,450))
		screen.blit(pygame.font.SysFont('Times New Roman', 40).render("5th", True, (255,255,255)), (60,520))
		if mode == 3 or mode == 4:
			screen.blit(pygame.font.SysFont('Times New Roman', 40).render("%d"%(sur_1p_top5[1]), True, (255,255,255)), (290,240))
			screen.blit(pygame.font.SysFont('Times New Roman', 40).render("%d"%(sur_1p_top5[2]), True, (255,255,255)), (290,310))
			screen.blit(pygame.font.SysFont('Times New Roman', 40).render("%d"%(sur_1p_top5[3]), True, (255,255,255)), (290,380))
			screen.blit(pygame.font.SysFont('Times New Roman', 40).render("%d"%(sur_1p_top5[4]), True, (255,255,255)), (290,450))
			screen.blit(pygame.font.SysFont('Times New Roman', 40).render("%d"%(sur_1p_top5[5]), True, (255,255,255)), (290,520))
			screen.blit(pygame.font.SysFont('Times New Roman', 40).render("%d"%(sur_2p_top5[1]), True, (255,255,255)), (680,240))
			screen.blit(pygame.font.SysFont('Times New Roman', 40).render("%d"%(sur_2p_top5[2]), True, (255,255,255)), (680,310))
			screen.blit(pygame.font.SysFont('Times New Roman', 40).render("%d"%(sur_2p_top5[3]), True, (255,255,255)), (680,380))
			screen.blit(pygame.font.SysFont('Times New Roman', 40).render("%d"%(sur_2p_top5[4]), True, (255,255,255)), (680,450))
			screen.blit(pygame.font.SysFont('Times New Roman', 40).render("%d"%(sur_2p_top5[5]), True, (255,255,255)), (680,520))
		if mode == 5 or mode == 6:
			screen.blit(pygame.font.SysFont('Times New Roman', 40).render("%d"%(catch_1p_top5[1]), True, (255,255,255)), (290,240))
			screen.blit(pygame.font.SysFont('Times New Roman', 40).render("%d"%(catch_1p_top5[2]), True, (255,255,255)), (290,310))
			screen.blit(pygame.font.SysFont('Times New Roman', 40).render("%d"%(catch_1p_top5[3]), True, (255,255,255)), (290,380))
			screen.blit(pygame.font.SysFont('Times New Roman', 40).render("%d"%(catch_1p_top5[4]), True, (255,255,255)), (290,450))
			screen.blit(pygame.font.SysFont('Times New Roman', 40).render("%d"%(catch_1p_top5[5]), True, (255,255,255)), (290,520))
			screen.blit(pygame.font.SysFont('Times New Roman', 40).render("%d"%(catch_2p_top5[1]), True, (255,255,255)), (680,240))
			screen.blit(pygame.font.SysFont('Times New Roman', 40).render("%d"%(catch_2p_top5[2]), True, (255,255,255)), (680,310))
			screen.blit(pygame.font.SysFont('Times New Roman', 40).render("%d"%(catch_2p_top5[3]), True, (255,255,255)), (680,380))
			screen.blit(pygame.font.SysFont('Times New Roman', 40).render("%d"%(catch_2p_top5[4]), True, (255,255,255)), (680,450))
			screen.blit(pygame.font.SysFont('Times New Roman', 40).render("%d"%(catch_2p_top5[5]), True, (255,255,255)), (680,520))
		pygame.display.update()
		for events in pygame.event.get():
			if events.type == pygame.KEYDOWN:	
				if events.key == pygame.K_ESCAPE:
