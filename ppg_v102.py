...
# Images Loading
background = pygame.image.load("images/tech.bmp").convert()
pic_o_p = pygame.image.load("images/one_player2.bmp").convert() 
exhibit_bls = pygame.image.load("images/small_tech.bmp").convert() 
exhibit_brs = pygame.image.load("images/long_tech.bmp").convert() 
exhibit_gm = pygame.image.load("images/gamemode.bmp").convert() 
control_w = pygame.image.load("images/50_50_tech_w.bmp").convert() 
control_s = pygame.image.load("images/50_50_tech_s.bmp").convert() 
control_a = pygame.image.load("images/50_50_tech_a.bmp").convert() 
control_d = pygame.image.load("images/50_50_tech_d.bmp").convert() 
control_up = pygame.image.load("images/50_50_tech_up.bmp").convert() 
control_down = pygame.image.load("images/50_50_tech_down.bmp").convert() 
control_left = pygame.image.load("images/50_50_tech_left.bmp").convert() 
control_right = pygame.image.load("images/50_50_tech_right.bmp").convert() 
control_30_w = pygame.image.load("images/30_tech_w.bmp").convert() 
control_30_s = pygame.image.load("images/30_tech_s.bmp").convert() 
control_30_up = pygame.image.load("images/30_tech_up.bmp").convert() 
control_30_down = pygame.image.load("images/30_tech_down.bmp").convert()
red_warning = pygame.image.load("images/red_warning.bmp").convert()
top_margin = pygame.image.load("images/960_60_tech.bmp").convert()
blackhole_70 = pygame.image.load("images/70_blackhole_light.bmp").convert()
blackhole_56 = pygame.image.load("images/56_blackhole_light.bmp").convert()
laser_50 = pygame.image.load("images/50_50_tech_laser.bmp").convert()
accel_50 = pygame.image.load("images/50_50_tech_accel.bmp").convert()
invis_50 = pygame.image.load("images/50_50_tech_invis.bmp").convert()
bounce_50 = pygame.image.load("images/50_50_tech_bounce.bmp").convert()
gra_50 = pygame.image.load("images/50_50_tech_gra.bmp").convert()
vibrate_50 = pygame.image.load("images/50_50_tech_vibrate.bmp").convert()
wh_50 = pygame.image.load("images/50_50_tech_wh.bmp").convert()
laser_50_dark = pygame.image.load("images/50_50_tech_laser_dark.bmp").convert()
accel_50_dark = pygame.image.load("images/50_50_tech_accel_dark.bmp").convert()
invis_50_dark = pygame.image.load("images/50_50_tech_invis_dark.bmp").convert()
bounce_50_dark = pygame.image.load("images/50_50_tech_bounce_dark.bmp").convert()
gra_50_dark = pygame.image.load("images/50_50_tech_gra_dark.bmp").convert()
vibrate_50_dark = pygame.image.load("images/50_50_tech_vibrate_dark.bmp").convert()
wh_50_dark = pygame.image.load("images/50_50_tech_wh_dark.bmp").convert()
control_down_dark = pygame.image.load("images/50_50_tech_down_dark.bmp").convert() 
...
def catch_2p_highscore():
    ...
    for i in [1, 2, 3, 4, 5]:
        record_top5[6][i] = string.atoi(f.readline())   
def cos(x):
    a = math.radians(x)
    ans = math.cos(a)
    return ans
...
while True: 
    ...
    if gamestate == "home_page":
        ...
        #screen.blit(pygame.font.SysFont('Source Code Pro', 120).render("Ping Pong Game", True, (171,171,171)), (80, 200))
    ...
    if gamestate == 'gamemode': 
        ...
        #f = pygame.font.Sysfont('Source Code Pro', 35)
        #testText = screen.blit(f.render("HELLO"), True, (255, 255, 255), (100, 100))
        if gm_select == 1:
            #screen.blit(pygame.font.SysFont('Times New Roman', 35).render("Player VS Computer", True, (255, 255, 255)), (525, 500))
            xxx = 0
        elif gm_select == 2:
            screen.blit(pygame.font.SysFont(None, 35).render("Player VS Player", True, (255, 255, 255)), (525, 500))
        elif gm_select == 3:
            ...
            screen.blit(pygame.font.SysFont('Times New Roman', 35).render("[Cooperation Mode]", True, (255, 255, 255)), (500, 500))
        screen.blit(pygame.font.SysFont(None, 80).render("Ping Pong Game", True, (171,171,171)), (30, 15))
